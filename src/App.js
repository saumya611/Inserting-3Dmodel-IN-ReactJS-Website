...
function Picker() {
  ...
  return (
    <div style={{ display: snap.current ? "block" : "none" }}>
      ...
      <h1 className="at">{snap.current}</h1>
    </div>
  );
}
...
export default function App() {
  return (
    <>
      ...
      <div>
        <iframe className="youiframe" width="200" height="100" src="https://www.youtube.com/embed/xy_tbV4pC54" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
